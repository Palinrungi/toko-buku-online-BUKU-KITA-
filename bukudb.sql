-- Active: 1729815355789@@127.0.0.1@3306@bukudb
...
ALTER TABLE PENGGUNA ADD COLUMN PASSWORD_PENGGUNA VARCHAR(20);

ALTER TABLE admin ADD COLUMN ID_ADMIN INT AUTO_INCREMENT PRIMARY KEY;
